...
CSV_INPUT = "3_results/nenets_whisper_large_ru_transcriptions.csv"
FINAL_CSV_PATH = "3_results/nenets_whisper_large_ru_for_review.csv"
TXT_REVIEW_PATH = "3_results/nenets_whisper_large_ru_for_review.txt"
