...
OUTPUT_DIR = "2_models/whisper-large-v3-nenets-ru"
...
def main():
    print("=" * 60)
    print("  WHISPER LARGE V3 FINE-TUNING PIPELINE - RUSSIAN CONFIG")
    print("=" * 60)
    ...
    class DataCollatorSpeechSeq2SeqWithPadding:
        ...
        def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
            ...
            batch["labels"] = labels
            # Cast input features to bfloat16 to match model dtype
    ...
    def compute_metrics(pred):
        # With predict_with_generate=False, just return empty (loss is monitored directly)
        return {}
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        # Increased batch size slightly for 32GB VRAM
        ...
        logging_steps=25,
        # Ensure deepspeed or DDP can run correctly if used later
    ...
    print("=" * 60)
    print("  WHISPER LARGE V3 TRAINING COMPLETE!")
    print("=" * 60)
