...
MODEL_PATH = "2_models/whisper-small-nenets-ru"
AUDIO_DIR = "1_data_prepared/inference_segments"
OUTPUT_FILE = "3_results/nenets_whisper_ru_transcriptions.csv"
...
def main():
    ...
    print(f"--- TRANSCRIBING {len(audio_files)} FILES WITH WHISPER (RU) ---")
